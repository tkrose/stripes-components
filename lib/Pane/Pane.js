...
class Pane extends React.Component {
  ...
  // getChildContext() {
  //   return {
  //     paneWidth: this.state.pixelWidth,
  //   };
  // }
  ...
  setStyle(style, pixelWidth) {
    if (this._isMounted) {
      this.setState((oldState) => {
        ...
        nextState.pixelWidth = pixelWidth;
        return nextState;
      });
    }
  }
  ...
  render() {
    ...
    return (
      <PaneContext.Provider value={{width: this.state.pixelWidth}}>
...
// Pane.childContextTypes = childContextTypes;
